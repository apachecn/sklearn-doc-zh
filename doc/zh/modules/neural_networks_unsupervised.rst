...
====================================
Neural network models (unsupervised)（神经网络模型（无监督））
====================================
...
Restricted Boltzmann machines（限制波尔兹曼机）
=============================
...
Graphical model and parametrization（图形模型和参数化）
-----------------------------------
...
Bernoulli Restricted Boltzmann machines（伯努利限制玻尔兹曼机）
---------------------------------------
...
Stochastic Maximum Likelihood learning（随机最大似然学习）
--------------------------------------
